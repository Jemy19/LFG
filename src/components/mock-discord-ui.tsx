...
import { Cog, Gift, Headphones, HelpCircle, Inbox, InboxIcon, Menu, Mic, Phone, Pin, PlusCircle, Search, Smile, Sticker, UserCircle, Video } from "lucide-react";
import Image from "next/image";

export const MockDiscordUI = ({children}: PropsWithChildren) => {
    return (
        <div className="flex min-h-[800px] w-full max-w-[1200] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
            {/* Sidebar */}
            <div className="hidden sm:flex w-[72px] bg-[#202225] py-3 flex-col items-center">
                ...
                <div className="w-8 h-[2px] bh-discord-background rounded-full my-2"/>
                {[...Array(5)].map((_, i) => (
                        <div key={i} className="size-12 bg-discord-background rounded-3xl flex items-center justify-center mb-3 hover:rounded-xl transition-all duration-200 hover:bg-discord-brand-color cursor-pointer">
                            <span className="text-lg font-semibold text-gray-400">
                                {String.fromCharCode(65 + i)}
                            </span>
                        </div>
                ))}
                {/* Used Group here so when hover both of them hovers at the same time */}
            ...
            <div className="hidden md:flex w-60 bg-[#2f3136] flex-col">
                <div className="px-4 h-16 border-b border-[#202225] flex items-center shadow-sm">
                    <div className="w-full bg-[#202225] text-sm rounded px-2 h-8 flex items-center text-gray-500 cursor-pointer">
                ...
                <div className="flex-1 overflow-y-auto pt-4">
                    ...
                    <div className="px-2 mb-4">
                        ...
                        <div className="flex items-center px-2 py-1.5 rounded hover:bg-[#393c43] text-white cursor-pointer">
                            <Image 
                ...
                <div className="p-2 bg-[#282b2f] flex items-center">
                    <div className="size-8 bg-brand-700 rounded-full mr-2"/>
            ...
            <div className="flex-1 flex flex-col">
                <div className="h-16 bg-[#36393f] flex items-center px-4 shadow-sm border-b border-[#202225]">
                    ...
                    <div className="ml-auto flex items-center space-x-4 text-[#b9bbbe]">
                        ...
                        <InboxIcon className="size-5 hover:text-white cursor-pointer hidden sm:block"/>
                        <HelpCircle className="size-5 hover:text-white cursor-pointer hidden sm:block"/>
                    </div>
                </div>
                {/* flex col reverse here para sa chat taas if may bago */}
                ...
                <div className="p-4">
                    <div className="flex items-center bg-[#40444b] rounded-lg p-1">
                        ...
                        <input readOnly type="text" placeholder="Message @PingPanda" className="flex-1 bg-transparent py=2.5 px-1 text-white placeholder-[#72767d] focus:outline-none"/>
